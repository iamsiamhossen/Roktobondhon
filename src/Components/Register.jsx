...
import { FaUserInjured, FaHandHoldingHeart, FaTint, FaUserPlus } from "react-icons/fa";
import PatientRegistration from "../components/patient/PatientRegister";
    ...
    >
      <div className="p-8 bg-white rounded-2xl shadow-2xl border border-red-200 w-full max-w-md mx-4">
        ...
        <div className="space-y-5">
          ...
          <button
            onClick={() => document.getElementById("patient_reg_modal").showModal()}
          ...
          <button
            onClick={() => document.getElementById("donor_reg_modal").showModal()}
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>প্রয়োজনে কল করুন: <span className="text-red-600 font-bold">০১৭XX-XXXXXX</span></p>
        </div>

        {/* Patient Registration Modal */}
        <dialog id="patient_reg_modal" className="modal modal-bottom sm:modal-middle">
        ...
        {/* Donor Registration Modal (Similar structure) */}
        <dialog id="donor_reg_modal" className="modal modal-bottom sm:modal-middle">
          {/* Similar modal structure with DonorRegistration component */}
        </dialog>
      </div>
    </div>
  );
